...
{
    class SearchResultsViewModel_Abroad : BaseViewModel
    {
        ...
        public SearchResultsViewModel_Abroad()
        {
        ...
        async Task GetUniversitiesFromAPI()
        {
            ...
            {
                Universities.Clear();
                var repoUniversities = await Repository_University.GetUniversities_Abroad(true);
